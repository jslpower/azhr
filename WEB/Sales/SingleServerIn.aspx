<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SingleServerIn.aspx.cs"
    Inherits="EyouSoft.Web.Sales.SingleServerIn" %>
                    ...
                    <ItemTemplate>
                        <tr data-registerid="<%#Eval("RegisterId") %>">
                            ...
                            <td align="center" data-status="<%#(int)Eval("Status") %>">
                                <a href="javascript:void(0);" class="a_Updata">修改</a>|<a class="a_Delete" href="javascript:void(0);">删除</a>|<a class="a_Print" href="javascript:void(0);">打印</a>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
    ...
    <script type="text/javascript">
        var Register = {
            ...
            Save: function(obj, type) {
                var that = this;
                var url = "/Sales/SingleServerIn.aspx?" + $.param({ doType: type, sl: '<%=Request.QueryString["sl"] %>' });
