<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChanPin.aspx.cs" Inherits="EyouSoft.Web.Sales.ChanPin"
        ...
        <div class="searchbox border-bot fixed">
            ...
            <span class="searchT">
                <p>
                    ...
                    抵达时间：<input onfocus="WdatePicker()" type="text" class="inputtext formsize100" name="txtBeginDateF"
                    ...
                    <br />
                    离境时间：<input onfocus="WdatePicker()" type="text" class="inputtext formsize100" name="txtEndDateF"
                    ...
                    OP:
                    <uc2:SellsSelect ID="SellsSelect2" runat="server" SetTitle="OP" SelectFrist="false" />
        ...
        <div class="tablehead">
            <ul class="fixed" id="btnAction">
                <asp:PlaceHolder ID="phForAdd" runat="server">
                    <li><s class="addicon"></s><a class="toolbar_add" hidefocus="true" href="ChanPinEdit.aspx?sl=<%=SL %>&act=add">
                ...
                <tbody>
                    ...
                    <asp:Repeater runat="server" ID="rpt_List">
                        <ItemTemplate>
                            <tr>
                                <td align="center">
                                    <input name="checkbox" id="checkbox" value="<%#Eval("tourId") %>" data-surestate='<%#Eval("TourSureStatus").ToString() %>'
                                        type="checkbox">
                                </td>
                                <td align="center">
                                    <a href='javascript:void(0)' class="a_update"><%#Eval("tourCode") %></a>
                                    <%#GetChangeInfo((bool)Eval("IsChange"), (bool)Eval("IsSure"), Eval("tourId").ToString(), Eval("TourStatus").ToString())%>
                                </td>
                                <td align="center">
                                    <a href='/PrintPage/XingChengDan.aspx?TourId=<%#Eval("TourId")%>' target="_blank"><%#Eval("RouteName")%></a>
                                </td>
                                <td align="center">
                                    <%#Eval("TourDays") %>
                                </td>
                                ...
                                <td align="right">
                                    <b class="fontblue">
                                        <%#Eval("ConfirmMoney", "{0:C2}")%></b>
                                </td>
                                <td align="right">
                                    <b class="fontgreen">
                                        <%#Eval("CheckMoney","{0:C2}") %></b>
                                </td>
                                <td align="right">
                                    <b class="fontred">
                                        <%#Eval("WeiShouJinE","{0:C2}") %></b>
                                </td>
                                <% } %>
                                <td align="center">
        ...
        var TeamplanList = {
            ...
            DelAll: function(objArr) {
                ...
                $.newAjax({
                    type: "get",
                    cache: false,
                    url: "/Sales/ChanPin.aspx?dotype=delete&ids=" + list.join(',') + "&" + $.param(TeamplanList.Data),
                    dataType: "json",
            ...
            RightClick: function(type, id) {
                switch (type) {
                    case "update":
                        window.location.href = "/Sales/ChanPinEdit.aspx?act=update&id=" + id + "&" + $.param(TeamplanList.Data);
                        break;
                    case "paituan":
                    ...
                    case "queren":
                        ...
                        break;
                    case "copy":
                        window.location.href = "/Sales/ChanPinEdit.aspx?act=copy&id=" + id + "&" + $.param(TeamplanList.Data);
                        break;
                }
                return false;
            },
        ...
        $(function() {
        	...
        	tableToolbar.init({
        			...
        			copyCallBack: function(arr) {
        				location.href = "ChanPinEdit.aspx?act=copy&id=" + arr[0].find(":checkbox").val() + "&" + $.param(TeamplanList.Data);
        				return false;
        			},
        			updateCallBack: function(arr) {
        				location.href = "ChanPinEdit.aspx?act=update&id=" + arr[0].find(":checkbox").val() + "&" + $.param(TeamplanList.Data);
        				return false;
        			},
        	...
        	$("#btnCanelSave").click(function() {
        		...
        		$.newAjax({
        				type: "GET",
        				url: "/Sales/CHanPin.aspx?doType=canel&ids=" + ids.join(',') + "&remarks=" + encodeURIComponent(remarks) + "&" + $.param(TeamplanList.Data),
        				dataType: "json",
        				success: function(r) {
        					if (r.result == "1") {
        	...
        	$(".a_update").click(function(){location.href = "ChanPinEdit.aspx?act=update&id=" + $(this).closest("tr").find(":checkbox").val() + "&" + $.param(TeamplanList.Data);})
