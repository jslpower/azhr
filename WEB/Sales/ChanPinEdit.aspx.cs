...
{
    public partial class ChanPinEdit : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        ...
        void InitInfo()
        {
            ...
            if (info.TourCostList != null && info.TourCostList.Count > 0)
            {
                ...
                /*if (info.TourCostList.Count == 24 || info.TourCostList.Count == 12)
                {
                    this.txt_Item_BTraffic.Text = info.TourCostList[0].Price.ToString("f2");
                    this.txt_Item_BTrafficRemark.Text = info.TourCostList[0].Remark;
                    this.txt_Item_Car.Text = info.TourCostList[1].Price.ToString("f2");
                    this.txt_Item_CarRemark.Text = info.TourCostList[1].Remark;
                    this.txt_Item_Room1.Text = info.TourCostList[2].Price.ToString("f2");
                    this.txt_Item_RoomRemark1.Text = info.TourCostList[2].Remark;
                    //this.txt_Item_Room2.Text = info.TourCostList[3].Price.ToString("f2");
                    //this.txt_Item_RoomRemark2.Text = info.TourCostList[3].Remark;
                    this.txt_Item_Dinner.Text = info.TourCostList[4].Price.ToString("f2");
                    this.txt_Item_DinnerRemark.Text = info.TourCostList[4].Remark;
                    this.txt_Item_Guide.Text = info.TourCostList[5].Price.ToString("f2");
                    this.txt_Item_GuideRemark.Text = info.TourCostList[5].Remark;
                    this.txt_Item_Scenic.Text = info.TourCostList[6].Price.ToString("f2");
                    this.txt_Item_ScenicRemark.Text = info.TourCostList[6].Remark;
                    this.txt_Item_Insure.Text = info.TourCostList[7].Price.ToString("f2");
                    this.txt_Item_InsureRemark.Text = info.TourCostList[7].Remark;
                    this.txt_Item_STraffic.Text = info.TourCostList[8].Price.ToString("f2");
                    this.txt_Item_STrafficRemark.Text = info.TourCostList[8].Remark;
                    this.txt_Item_Sum.Text = info.TourCostList[9].Price.ToString("f2");
                    this.txt_Item_SumRemark.Text = info.TourCostList[9].Remark;
                    this.txt_Item_Other.Text = info.TourCostList[10].Price.ToString("f2");
                    this.txt_Item_OtherRemark.Text = info.TourCostList[10].Remark;
                    this.txt_Item_FreeOne.Text = info.TourCostList[11].Price.ToString("f2");
                    this.txt_Item_FreeOneRemark.Text = info.TourCostList[11].Remark;
                    if (info.TourCostList.Count == 24)
                    {
                        this.txt_Price_BTraffic.Text = info.TourCostList[12].Price.ToString("f2");
                        this.txt_Price_BTrafficRemark.Text = info.TourCostList[12].Remark;

                        this.txt_Price_Car.Text = info.TourCostList[13].Price.ToString("f2");
                        this.txt_Price_CarRemark.Text = info.TourCostList[13].Remark;

                        this.txt_Price_Room1.Text = info.TourCostList[14].Price.ToString("f2");
                        this.txt_Price_RoomRemark1.Text = info.TourCostList[14].Remark;

                        //this.txt_Price_Room2.Text = info.TourCostList[15].Price.ToString("f2");
                        //this.txt_Price_RoomRemark2.Text = info.TourCostList[15].Remark;

                        this.txt_Price_Dinner.Text = info.TourCostList[16].Price.ToString("f2");
                        this.txt_Price_DinnerRemark.Text = info.TourCostList[16].Remark;

                        this.txt_Price_Guide.Text = info.TourCostList[17].Price.ToString("f2");
                        this.txt_Price_GuideRemark.Text = info.TourCostList[17].Remark;

                        this.txt_Price_Scenic.Text = info.TourCostList[18].Price.ToString("f2");
                        this.txt_Price_ScenicRemark.Text = info.TourCostList[18].Remark;

                        this.txt_Price_Insure.Text = info.TourCostList[19].Price.ToString("f2");
                        this.txt_Price_InsureRemark.Text = info.TourCostList[19].Remark;

                        this.txt_Price_STraffic.Text = info.TourCostList[20].Price.ToString("f2");
                        this.txt_Price_STrafficRemark.Text = info.TourCostList[20].Remark;

                        this.txt_Price_Sum.Text = info.TourCostList[21].Price.ToString("f2");
                        this.txt_Price_SumRemark.Text = info.TourCostList[21].Remark;

                        this.txt_Price_Other.Text = info.TourCostList[22].Price.ToString("f2");
                        this.txt_Price_OtherRemark.Text = info.TourCostList[22].Remark;

                        this.txt_Price_FreeOne.Text = info.TourCostList[23].Price.ToString("f2");
                        this.txt_Price_FreeOneRemark.Text = info.TourCostList[23].Remark;
                    }
                }*/
            }
            #endregion
        ...
        EyouSoft.Model.HTourStructure.MTour GetFormInfo()
        {
            ...
            //info.SalerIncome = Utils.GetDecimal(Utils.GetFormEditorValue(txtXiaoShouShouKuanJinE.UniqueID));
            info.Guides = null;
            ...
            if (type == "free")
            {
                ...
                info.TourType = EyouSoft.Model.EnumType.TourStructure.TourType.团队产品;
