...
{
    public partial class DaoYouDaiTuanPaiMing : EyouSoft.Common.Page.BackPage
    {
        ...
        void InitRpt()
        {
            ...
            int recordCount = 0;
            var items = new EyouSoft.BLL.TongJiStructure.BDaoYouYeJi().GetDaoYouDaiTuans(CurrentUserCompanyID, chaXun);
            var items1 = Utils.FenYe<EyouSoft.Model.TongJiStructure.MDaoYouDaiTuanInfo>(pageSize, pageIndex, out recordCount, items);
        ...
        /// </summary>
        /// <returns></returns>
        EyouSoft.Model.TongJiStructure.MDaoYouDaiTuanChaXunInfo GetChaXunInfo()
        {
            var info = new EyouSoft.Model.TongJiStructure.MDaoYouDaiTuanChaXunInfo();
