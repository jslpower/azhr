<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DaoYouYeJiPaiMing.aspx.cs"
    Inherits="EyouSoft.Web.Sta.DaoYouYeJiPaiMing" MasterPageFile="~/MasterPage/Front.Master" %>
    ...
    <div class="mainbox">
        <div class="tablehead border-bot">
            <ul class="fixed">
                ...
                <li><a href="DaoYouYeJiPaiMing.aspx?sl=<%=SL %>" class="ztorderform  de-ztorderform"><s class="orderformicon">
                </s><span>业绩排名</span></a></li>
                <li><a href="DaoYouDaiTuanPaiMing.aspx?sl=<%=SL %>" class="ztorderform">
                    <s class="orderformicon"></s><span>带团人数排名</span></a></li>
            </ul>
        </div>
            ...
            <span class="searchT">
                <p>
                    ...
                    <select name="txtPaiXu" id="txtPaiXu">
                        <option value="0">人均越高</option>
                        <option value="1">人均越低</option>
                        <option value="2">营业额超高</option>
                        <option value="3">营业额超低</option>
                    </select>
