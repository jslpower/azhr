...
namespace EyouSoft.Web.CommonPage.AjaxRequest
{
    public partial class AjaxSupplier : BackPage
    {
        ...
        private void ListDataInit(string provice, string city, string area, string name)
        {
            ...
            //供应商选用类别
            string type = Utils.GetQueryStringValue("suppliertype");
            ...
            if (searchmodel.LeiXing == EyouSoft.Model.EnumType.GysStructure.GysLeiXing.酒店)
            {
                int lngtype = Utils.GetInt(Utils.GetQueryStringValue("LgType")) == 0 ? 1 : Utils.GetInt(Utils.GetQueryStringValue("LgType"));
                searchmodel.LngType = (EyouSoft.Model.EnumType.SysStructure.LngType)lngtype;
        ...
        {
            this.ExporPageInfoSelect1.PageLinkURL = "/CommonPage/UserSupplier.aspx?";
