<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriceRemark.aspx.cs" Inherits="EyouSoft.Web.CommonPage.PriceRemark" %>
    ...
    <div class="alertbox-outbox02">
        <table width="99%" cellspacing="0" cellpadding="0" border="0" style="margin: 0 auto;"
            ...
            <tbody>
                ...
                <asp:Literal ID="litMsg" runat="server" Text="<tr><td align='center' colspan='2'>暂无数据!</td></tr>"></asp:Literal>
            </tbody>
        </table>
        <div class="tablehead">
            <div class="pages">
        ...
        var SelectInformation = {
            ...
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/CommonPage/PriceRemark.aspx?type=save&sl=" + SelectInformation.sl + "&LngType=" + SelectInformation.LngType,
