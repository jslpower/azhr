<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JourneySpot.aspx.cs" Inherits="EyouSoft.Web.CommonPage.JourneySpot" %>
        ...
        var SelectInformation = {
            ...
            Save: function() {
                ...
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "/CommonPage/JourneySpot.aspx?type=save&sl=" + SelectInformation.sl + "&LngType=" + SelectInformation.LngType + "&AreaID=" + SelectInformation.AreaID,
