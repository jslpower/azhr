<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selectScenicPrice.aspx.cs"
    Inherits="EyouSoft.Web.CommonPage.selectScenicPrice" %>
...
<body>
    ...
    <div class="alertbox-outbox">
        <div style="margin: 0 auto; width: 99%;">
            <span class="formtableT formtableT02 t1">选择景点价格 </span>
                ...
                <asp:Repeater runat="server" ID="RepList">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="left" height="30px">
                                <%#Convert.ToDateTime(Eval("STime")).ToString("yyyy-MM-dd") %>
                            </td>
                            <td align="left" height="30px">
                                <%#Convert.ToDateTime(Eval("ETime")).ToString("yyyy-MM-dd") %>
                            </td>
                            <td align="left" height="30px">
