<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectScenic.aspx.cs" Inherits="EyouSoft.Web.CommonPage.SelectScenic" %>
    ...
    <div>
        <div style="margin: 0 auto; width: 99%;">
            ...
            <input type="button" value="新增" class="search-btn" id="btn_add" style="cursor: pointer;
                ...
                <a id="a_btn" hidefocus="true" href="javascript:void(0)"><s class="xuanzhe"></s>选 择</a>
                </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var data = {
                ...
                tourmode: '<%=Request.QueryString["tourmode"] %>',
            ...
            $("#tblList input").click(function() {
                if (this.checked) {
                    ...
                    if (self.attr("data-isHas") == "yes") {
                        ...
                        url += $.param({ hideID: hideObj, callBack: "CallBackJDPrice", priceId: hidpricceid, parentiframeid: '<%=Request.QueryString["iframeId"] %>', binkemode: data.binkemode, tourmode: data.tourmode, sdate: data.sdate, edate: data.edate })
        ...
        $("#btn_add").click(function() {
            top.Boxy.iframeDialog({
                title: "新增供应商",
                iframeUrl: "/Gys/jingdianEdit.aspx?sl=38",
                width: "940px",
                height: "650px",
                afterHide: function() { useSupplierPage.reload(); }
            });
            return false;
        })
