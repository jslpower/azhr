...
namespace EyouSoft.Web.Plan
{
    ...
    /// 计调中心-区间交通-飞机
    /// </summary>
    public partial class PlanPlaneList : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        //确认单
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            querenUrl = new EyouSoft.BLL.ComStructure.BComSetting().GetPrintUri(this.SiteUserInfo.CompanyId, EyouSoft.Model.EnumType.ComStructure.PrintTemplateType.机票确认单);
        ...
        protected void DataInit()
        {
            ...
            if (!string.IsNullOrEmpty(tourId))
            {
                ...
                IList<EyouSoft.Model.HPlanStructure.MPlan> LargeList = new EyouSoft.BLL.HPlanStructure.BPlan().GetList(EyouSoft.Model.EnumType.PlanStructure.PlanProject.飞机, null, null, false, null, tourId);
        ...
        protected void GetLargeModel()
        {
            ...
            if (!string.IsNullOrEmpty(planId))
            {
                EyouSoft.Model.HPlanStructure.MPlanBaseInfo LargeModel = new EyouSoft.BLL.HPlanStructure.BPlan().GetModel(EyouSoft.Model.EnumType.PlanStructure.PlanProject.飞机, planId);
                if (LargeModel != null)
                {
        ...
        void PageSave()
        {
            ...
            LargeBase.Type = EyouSoft.Model.EnumType.PlanStructure.PlanProject.飞机;
