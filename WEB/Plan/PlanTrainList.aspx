<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanTrainList.aspx.cs"
    Inherits="EyouSoft.Web.Plan.PlanTrainList" %>
                    ...
                    <tr>
                        ...
                        <td width="85%" colspan="3">
                            <label for="r1">
                                ...
                                飞机</label>
                            <input name="radioLartype" id="r2" type="radio" value="2" checked="checked" />
                            <label for="r2">
                                火车</label>
                            <input name="radioLartype" id="r3" type="radio" value="3" />
                            <label for="r3">
                                汽车</label>
                            <input name="radioLartype" id="r4" type="radio" value="4" />
                            <label for="r4">
                                轮船</label>
                        </td>
                    </tr>
                            ...
                            <table id="tabLargeFilght" width="100%" border="0" cellspacing="0" cellpadding="0"
                                ...
                                <asp:PlaceHolder ID="tabHolderView" runat="server">
                                    <tr class="tempRow">
                                        <td>
                                            ...
                                            时间<input type="text" class="inputtext formsize40" name="txtStartHours" data-title="点时间"
                                                data-class="show" />
                                            ...
                                            目的地<input type="text" class="inputtext formsize40" name="txtendPlace" data-title="目的地"
                                                data-class="show" />
                                            车次<input type="text" class="inputtext formsize50" name="txtFilghtnumbers" data-title="车次"
                                                data-class="show" /><br />
                                            座位标准<input type="text" class="inputtext formsize50" name="txtSeatStandard" data-title="座位标准"
                                                data-class="show" />
                                            价格<input type="text" class="inputtext formsize40" data-class="show" data-title="价格"
                                                name="txtprices" valid="required|isMoney" errmsg="*请输入价格!|*价格有误!" />元 手续费<input type="text"
                                                    class="inputtext formsize40" data-class="show" data-title="手续费" name="txtShouxufei"
                                                    valid="required|isMoney" errmsg="*请输入手续费!|*手续费有误!" />元&nbsp; 付费数量<input type="text"
                                                        class="inputtext formsize40" data-class="show" data-title="付费数量" name="txtpeopleNums"
                                                        valid="required|RegInteger" errmsg="*请输入付费数量!|*付费数量必须是正整数!" />&nbsp;
                                            免费数量<input type="text" class="inputtext formsize40" data-class="show" data-title="免费数量"
                                                name="txtFreeNumber" valid="required|RegInteger" errmsg="*请输入免费数量!|*免费数量必须是正整数!" />&nbsp;
                                ...
                                <asp:Repeater ID="repFilght" runat="server">
                                    <ItemTemplate>
                                        <tr class="tempRow">
                                            <td>
                                                出发日期<input type="text" name="txtstartTime" id="txtstartTime" class="inputtext" valid="required"
                                                ...
                                                车次<input type="text" class="inputtext formsize50" name="txtFilghtnumbers" value="<%# Eval("Numbers") %>"
                                                    data-title="车次" data-class="show" /><br />
                                                座位标准<input type="text" class="inputtext formsize50" name="txtSeatStandard" data-title="座位标准"
                                                    value="<%# Eval("SeatStandard") %>" data-class="show" />
                                                价格<input type="text" class="inputtext formsize40" name="txtprices" valid="required|isMoney"
                                                    errmsg="*请输入价格!|*价格有误!" data-class="show" data-title="单价" value="<%# EyouSoft.Common.Utils.FilterEndOfTheZeroDecimal(Convert.ToDecimal(Eval("FarePrice"))) %>" />元&nbsp;
                                                手续费<input type="text" class="inputtext formsize40" data-class="show" data-title="手续费"
                                                    name="txtShouxufei" valid="required|isMoney" errmsg="*请输入手续费!|*手续费有误!" value="<%# EyouSoft.Common.Utils.FilterEndOfTheZeroDecimal(Convert.ToDecimal(Eval("InsuranceHandlFee"))) %>" />元&nbsp;
                                                付费数量：<input type="text" class="inputtext formsize40" name="txtpeopleNums" valid="required|RegInteger"
                                                    errmsg="*请输入付费数量!|*付费数量必须是正整数!" min="1" data-class="show" data-title="付费数量" value="<%# EyouSoft.Common.Utils.FilterEndOfTheZeroDecimal(Convert.ToDecimal(Eval("PepolePayNum"))) %>" />
                                                免费数量：<input type="text" class="inputtext formsize40" name="txtFreeNumber" valid="required|RegInteger"
                                                    errmsg="*请输入免费数量!|*免费数量必须是正整数!" min="1" data-class="show" data-title="免费数量" value="<%# EyouSoft.Common.Utils.FilterEndOfTheZeroDecimal(Convert.ToDecimal(Eval("FreeNumber"))) %>" />
                        ...
                        <asp:Repeater ID="repLargeList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href='<%# querenUrl %>?planId=<%#Eval("PlanId")%>&t=<%#(int)EyouSoft.Model.EnumType.PlanStructure.PlanProject.火车 %>' target="_blank">
    ...
    <script type="text/javascript">
        var LargePage = {
            ...
            _DeleteCar: function(objID) {
                var _Url = '/Plan/PlanTrainList.aspx?sl=' + LargePage.sl + '&type=' + LargePage.type + '&tourId=' + LargePage.tourId + "&iframeId=" + LargePage.iframeId + "&m=" + new Date().getTime();
                $.newAjax({
                    type: "get",
                    url: '/Plan/PlanTrainList.aspx?sl=' + LargePage.sl + '&action=delete&PlanId=' + objID + '&tourid=' + LargePage.tourId,
                    cache: false,
                    dataType: "json",
            ...
            _SaveCar: function(planId, tourId) {
                ...
                $.newAjax({
                    type: "POST",
                    url: '/Plan/PlanTrainList.aspx?sl=' + LargePage.sl + '&action=save&planId=' + planId + "&tourId=" + tourId,
                    cache: false,
            ...
            _TotalPrices: function() {
                ...
                $("input[type=text][name='txtXiaoJi']").each(function() {
                    ...
                    var shouxufei = trClass.find("input[type=text][name='txtShouxufei']").val();
                    var TotalPrices = tableToolbar.calculate(tableToolbar.calculate(shouxufei, peopleNums, "*"), tableToolbar.calculate(peopleNums, prices, "*"), "+");
            ...
            _BIndBtn: function() {
                ...
                $("#Largelist").find("[data-class='updateLarge']").click(function() {
                    ...
                    if (PlanId != "") {
                        window.location.href = '/Plan/PlanTrainList.aspx?sl=' + LargePage.sl + '&action=update&PlanId=' + PlanId + '&tourId=' + LargePage.tourId + '&iframeId=' + LargePage.iframeId;
                    }
                    return false;
                });
                ...
                $("#Largelist").find("[data-class='showLarge']").click(function() {
                    var PlanId = $(this).find("img").attr("data-Id");
                    if (PlanId != "") {
                        window.location.href = '/Plan/PlanTrainList.aspx?sl=' + LargePage.sl + '&action=update&PlanId=' + PlanId + '&tourId=' + LargePage.tourId + '&iframeId=' + LargePage.iframeId + "&show=1";
                    }
                    return false;
                });
                ...
                //失去焦点计算价格
                $("input[type='text'][name='txtpeopleNums'],input[type='text'][name='txtprices'],input[type='text'][name='txtShouxufei'],input[type='text'][name='txtXiaoJi']").blur(function() {
