<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="PlanStaCheDui.aspx.cs" Inherits="EyouSoft.Web.Plan.PlanStaCheDui" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="tablehead border-bot">
        <ul class="fixed">
            ...
            <li><a href="PlanStaCheDui.aspx?sl=<%=SL %>" class="ztorderform de-ztorderform"><s
                class="orderformicon"></s><span>车队</span></a></li>
    ...
    <div class="searchbox border-bot fixed">
        ...
        <span class="searchT">
            <p>
                ...
                车队名称：<uc1:supplierControl ID="supplierControl1" runat="server" SupplierType="车队"
                    IsMust="false" />
