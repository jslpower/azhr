<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanQiCheList.aspx.cs" Inherits="EyouSoft.Web.Plan.PlanQiCheList" %>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" class="jd-table01" style="border-bottom: 1px solid #A9D7EC;
                    ...
                    <tr>
                        ...
                        <td width="85%" colspan="3">
                            ...
                            <label for="r2">
                                火车</label>
                            <input name="radioLartype" id="r3" type="radio" value="3" checked="checked" />
                            <label for="r3">
                                汽车</label>
                                    ...
                                    <tr class="tempRow">
                                        <td>
                                            ...
                                            目的地<input type="text" class="inputtext formsize40" name="txtendPlace" data-title="目的地"
                                                data-class="show" /><br />
                                            车牌号<input type="text" class="inputtext formsize50" name="txtFilghtnumbers" data-title="车牌号"
                                                data-class="show" />
                                            张数<input type="text" class="inputtext formsize40" data-class="show" data-title="张数"
                                                name="txtpeopleNums" valid="required|RegInteger" errmsg="*请输入张数!|*张数必须是正整数!" />&nbsp;
                                        ...
                                        <tr class="tempRow">
                                            <td>
                                                ...
                                                目的地<input type="text" class="inputtext formsize40" name="txtendPlace" value="<%# Eval("Destination") %>"
                                                    data-title="目的地" data-class="show" /><br />
                                                车牌号<input type="text" class="inputtext formsize50" name="txtFilghtnumbers" value="<%# Eval("Numbers") %>"
                                                    data-title="车牌号" data-class="show" />
                                                张数<input type="text" class="inputtext formsize40" name="txtpeopleNums" valid="required|RegInteger"
                                                    errmsg="*请输入张数!|*张数必须是正整数!" min="1" data-class="show" data-title="张数" value="<%# EyouSoft.Common.Utils.FilterEndOfTheZeroDecimal(Convert.ToDecimal(Eval("PepolePayNum"))) %>" />
                        ...
                        <asp:Repeater ID="repLargeList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href='<%# querenUrl %>?planId=<%#Eval("PlanId")%>&t=<%#(int)EyouSoft.Model.EnumType.PlanStructure.PlanProject.汽车 %>' target="_blank">
    ...
    <script type="text/javascript">
        var LargePage = {
            ...
            _DeleteCar: function(objID) {
                var _Url = '/Plan/PlanQiCheList.aspx?sl=' + LargePage.sl + '&type=' + LargePage.type + '&tourId=' + LargePage.tourId + "&iframeId=" + LargePage.iframeId + "&m=" + new Date().getTime();
                $.newAjax({
                    type: "get",
                    url: '/Plan/PlanQiCheList.aspx?sl=' + LargePage.sl + '&action=delete&PlanId=' + objID + '&tourid=' + LargePage.tourId,
                    cache: false,
                    dataType: "json",
            ...
            _SaveCar: function(planId, tourId) {
                ...
                $.newAjax({
                    type: "POST",
                    url: '/Plan/PlanQiCheList.aspx?sl=' + LargePage.sl + '&action=save&planId=' + planId + "&tourId=" + tourId,
                    cache: false,
            ...
            _BIndBtn: function() {
                ...
                $("#Largelist").find("[data-class='updateLarge']").click(function() {
                    ...
                    if (PlanId != "") {
                        window.location.href = '/Plan/PlanQiCheList.aspx?sl=' + LargePage.sl + '&action=update&PlanId=' + PlanId + '&tourId=' + LargePage.tourId + '&iframeId=' + LargePage.iframeId;
                    }
                    return false;
                });
                ...
                $("#Largelist").find("[data-class='showLarge']").click(function() {
                    var PlanId = $(this).find("img").attr("data-Id");
                    if (PlanId != "") {
                        window.location.href = '/Plan/PlanQiCheList.aspx?sl=' + LargePage.sl + '&action=update&PlanId=' + PlanId + '&tourId=' + LargePage.tourId + '&iframeId=' + LargePage.iframeId + "&show=1";
                    }
                    return false;
                });
                ...
                //失去焦点计算价格
                $("input[type='text'][name='txtpeopleNums'],input[type='text'][name='txtprices'],input[type='text'][name='txtXiaoJi']").blur(function() {
