<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="PlanStaCanGuan.aspx.cs" Inherits="EyouSoft.Web.Plan.PlanStaCanGuan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainbox">
        <div class="tablehead border-bot">
            <ul class="fixed">
                <li><a href="PlanStaJiuDian.aspx?sl=<%=SL %>" class="ztorderform"><s class="orderformicon">
                </s><span>酒店</span></a></li>
                <li><a href="PlanStaCanGuan.aspx?sl=<%=SL %>" class="ztorderform de-ztorderform"><s class="orderformicon">
                </s><span>餐厅</span></a></li>
            ...
            <span class="searchT">
                <p>
                    ...
                    <select class="inputselect" name="dueToway">
                     ...
                     餐厅名称：<uc1:supplierControl ID="supplierControl1" runat="server" SupplierType="餐馆"
                        IsMust="false" />
                    用餐日期：
                   ...
                   <select class="inputselect" name="yctime">
                        <asp:Literal ID="litYctime" runat="server"></asp:Literal>
                    </select>
