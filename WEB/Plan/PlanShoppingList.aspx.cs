...
namespace EyouSoft.Web.Plan
{
    ...
    /// 计调中心-购物安排
    /// </summary>
    public partial class PlanShoppingList : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        //确认单
        ...
        {
            Privs_AnPai = CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.计调中心_计调列表_安排购物);
        }
        #endregion
        ...
        protected void PageInit()
        {
            ...
            if (!string.IsNullOrEmpty(tourId))
            {
                ...
                IList<EyouSoft.Model.HPlanStructure.MPlan> List = new EyouSoft.BLL.HPlanStructure.BPlan().GetList(EyouSoft.Model.EnumType.PlanStructure.PlanProject.购物, null, null, false, null, tourId);
        ...
        protected void GetModel()
        {
            ...
            if (!string.IsNullOrEmpty(planId))
            {
                EyouSoft.Model.HPlanStructure.MPlanBaseInfo baseinfo = new EyouSoft.BLL.HPlanStructure.BPlan().GetModel(EyouSoft.Model.EnumType.PlanStructure.PlanProject.购物, planId);
                if (baseinfo != null)
                {
