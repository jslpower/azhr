<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanPlaneList.aspx.cs"
    Inherits="EyouSoft.Web.Plan.PlanPlaneList" %>
                        ...
                        <asp:Repeater ID="repLargeList" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href='<%# querenUrl %>?planId=<%#Eval("PlanId")%>&t=<%#(int)EyouSoft.Model.EnumType.PlanStructure.PlanProject.飞机 %>' target="_blank">
    ...
    <script type="text/javascript">
        var LargePage = {
            ...
            _DeleteCar: function(objID) {
                var _Url = '/Plan/PlanPlaneList.aspx?sl=' + LargePage.sl + '&type=' + LargePage.type + '&tourId=' + LargePage.tourId + "&iframeId=" + LargePage.iframeId + "&m=" + new Date().getTime();
                $.newAjax({
                    type: "get",
                    url: '/Plan/PlanPlaneList.aspx?sl=' + LargePage.sl + '&action=delete&PlanId=' + objID + '&tourid=' + LargePage.tourId,
                    cache: false,
                    dataType: "json",
            ...
            _SaveCar: function(planId, tourId) {
                ...
                $.newAjax({
                    type: "POST",
                    url: '/Plan/PlanPlaneList.aspx?sl=' + LargePage.sl + '&action=save&planId=' + planId + "&tourId=" + tourId,
                    cache: false,
            ...
            _BIndBtn: function() {
                ...
                $("#Largelist").find("[data-class='updateLarge']").click(function() {
                    ...
                    if (PlanId != "") {
                        window.location.href = '/Plan/PlanPlaneList.aspx?sl=' + LargePage.sl + '&action=update&PlanId=' + PlanId + '&tourId=' + LargePage.tourId + '&iframeId=' + LargePage.iframeId;
                    }
                    return false;
                });
                ...
                $("#Largelist").find("[data-class='showLarge']").click(function() {
                    var PlanId = $(this).find("img").attr("data-Id");
                    if (PlanId != "") {
                        window.location.href = '/Plan/PlanPlaneList.aspx?sl=' + LargePage.sl + '&action=update&PlanId=' + PlanId + '&tourId=' + LargePage.tourId + '&iframeId=' + LargePage.iframeId + "&show=1";
                    }
                    return false;
                });
