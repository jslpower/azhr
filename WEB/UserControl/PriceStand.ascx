...
<script type="text/javascript">
    ...
    $(function() {
    	$("input[data-issystem='True']").live("change", function() {
    		var _this = $(this);
    		var _class = $(_this).attr("class");

    		$(_this).closest("tr").find("input[data-issystem='False'][class='" + _class + "']").each(function() {
    			$(this).val(tableToolbar.calculate(
    				tableToolbar.getFloat($(_this).val()),
    				(tableToolbar.calculate(
    					1,
    					(tableToolbar.calculate(
    						tableToolbar.getFloat($(this).attr("data-FloatMoney")),
    						100,
    						"/")),
    					"-")),
    				"*"));
