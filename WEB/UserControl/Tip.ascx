<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Tip.ascx.cs" Inherits="EyouSoft.Web.UserControl.Tip" %>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#table_Tip").delegate("input[name='txt_Quote_Price']", "blur", function() {
            ...
            setTimeout(AddPrice.SumTipPrice, 100);
            setTimeout(AddPrice.SetTotalPrice, 200);
            setTimeout(AddPrice.SetHeJiPrice, 300);
        })
