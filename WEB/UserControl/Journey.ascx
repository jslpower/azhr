<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Journey.ascx.cs" Inherits="EyouSoft.Web.UserControl.Journey" %>
...
<script type="text/javascript">
    var Journey = {
        ...
        SelectSince: function(obj) {
            ...
            var param = { binkemode: binkemode, tourmode: tourmode, sdate: sdate, edate: edate, cityids: cityids.join(','), scenicids: scenicIds };
        ...
        SumPriceJingDian: function() {//计算景点价格合计
            ...
            $(".tdScenicCost").find("input").first().val(tableToolbar.getFloat(sumpricejs + selfpricejs - selfcost));
            $(".tdScenicPrice").find("input").first().val(tableToolbar.getFloat(sumpriceth + selfpriceth - selfcost));
        },
...
//        });
        ...
        $(".xuanyonghotel").live("click", function() {
            ...
            var binkemode = $.trim($("#hidbinkemode").val());
            var tourmode = $("#hidtourmode").val();
            url += $.param({ suppliertype: 1, hideID: $(hideObj).val(), callBack: "CallBackHotel", ShowID: showObj.attr("id"), binkemode: binkemode, tourmode: tourmode, jiudianxingji: $(".ddlJiuDianXingJi").val() });
            Boxy.iframeDialog({
                iframeUrl: url,
                title: "选择酒店",
                modal: true,
        ...
        $(".canguanbox").live("click", function() {
            ...
            url += $.param({ suppliertype: 2, hideID: $(hideObj).val(), callBack: "CallBackCanGuan", ShowID: $(showObj).val(), hidcaidanid: $(hidemenu).val() })
            Boxy.iframeDialog({
                iframeUrl: url,
                title: "选择餐馆",
                modal: true,
            ...
            <tr>
                ...
                <td align="center" rowspan="2" class="tdHotel">
                    ...
                    <span>
                        ...
                        <input type="text" readonly="readonly" style="background-color: #dadada" class="formsize120 inputtext"
                            name="txthotel2">
                        <a class="xuanyonghotel xuanyong" data-hotel="hotel2" href="javascript:;">&nbsp;</a>
                        价格
                        <input type="text" class="formsize40 inputtext" name="txthotel2price"></span>
                </td>
                    ...
                    <tr>
                        ...
                        <td align="center" rowspan="2" class="tdHotel">
                            ...
                            <span>
                                ...
                                <a class="xuanyonghotel xuanyong" data-hotel="hotel2" href="javascript:;">&nbsp;</a>
                                价格
                                <input type="text" class="formsize40 inputtext" name="txthotel2price" value='<%#Convert.ToDecimal(Eval("HotelPrice2")).ToString("f2") %>' />
                            </span>
                        </td>
                        <td align="left" colspan="2">
