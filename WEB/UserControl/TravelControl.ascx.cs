...
namespace EyouSoft.Web.UserControl
{
    ...
    public partial class TravelControl : System.Web.UI.UserControl
    {
        ...
        /// 设置控件的数据源
        /// </summary>
        private IList<EyouSoft.Model.HTourStructure.MTourOrderTraveller> _YouKes;

        public IList<EyouSoft.Model.HTourStructure.MTourOrderTraveller> YouKes
        {
            get { return GetFormInfo(); }
            set { _YouKes = value; }
        }

        IList<EyouSoft.Model.HTourStructure.MTourOrderTraveller> GetFormInfo()
        {
            IList<EyouSoft.Model.HTourStructure.MTourOrderTraveller> items = new List<EyouSoft.Model.HTourStructure.MTourOrderTraveller>();
            ...
            for (int i = 0; i < txt_TravelControl_TreavelID.Length; i++)
            {
                ...
                var item = new EyouSoft.Model.HTourStructure.MTourOrderTraveller();
