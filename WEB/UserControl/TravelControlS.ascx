<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TravelControlS.ascx.cs" Inherits="EyouSoft.Web.UserControl.TravelControlS" %>
...
<table width="100%" border="0" id="TravelControl_tbl">
    <tbody>
        ...
        <tr class="tempRow">
            ...
            <td align="center">
                <input type="text" class="inputtext formsize80" name="txt_TravelControl_Remarks">
            </td>            
            <td align="center">
