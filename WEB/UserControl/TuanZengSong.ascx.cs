...
{
    public partial class TuanZengSong : System.Web.UI.UserControl
    {
        /// <summary>
        /// 设置控件的数据源
        /// </summary>
        public IList<EyouSoft.Model.HTourStructure.MTourGive> SetZengSong { get; set; }
        ...
        {
            this.rpGive.DataSource = this.SetZengSong;
        ...
        /// 获取控件的数据
        /// </summary>
        public IList<EyouSoft.Model.HTourStructure.MTourGive> GetDataList()
        {
            IList<EyouSoft.Model.HTourStructure.MTourGive> items = new List<MTourGive>();
            ...
            {
                items = new List<EyouSoft.Model.HTourStructure.MTourGive>();
