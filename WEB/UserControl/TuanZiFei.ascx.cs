...
{
    public partial class TuanZiFei : System.Web.UI.UserControl
    {
        /// <summary>
        /// 设置控件的数据源
        /// </summary>
        public IList<EyouSoft.Model.HTourStructure.MTourSelfPay> SetZiFei { get; set; }
        ...
        {
            this.rpSelfPay.DataSource = this.SetZiFei;
        ...
        /// 获取控件的数据
        /// </summary>
        public IList<EyouSoft.Model.HTourStructure.MTourSelfPay> GetDataList()
        {
            ...
            IList<EyouSoft.Model.HTourStructure.MTourSelfPay> items = new List<EyouSoft.Model.HTourStructure.MTourSelfPay>();
            if (CityIds.Length > 0 && CityNames.Length > 0 && ScenicSpotIds.Length > 0 && ScenicSpotNames.Length > 0 && Prices.Length > 0)
            {
                items = new List<EyouSoft.Model.HTourStructure.MTourSelfPay>();
