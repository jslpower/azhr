<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SelfPay.ascx.cs" Inherits="EyouSoft.Web.UserControl.SelfPay" %>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#Tab_SelfPay .xuanyongscenic").live("click", function() {
            ...
            url += $.param({ callBack: "CallBackJingDian", IsMultiple: 1, cityids: citys, scenicids: scenicd, scenicpriceid: scenicpriceid, binkemode: binkemode, tourmode:tourmode, sdate: sdate, edate: edate });
