<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TuanFengWeiCan.ascx.cs"
    Inherits="EyouSoft.Web.UserControl.TuanFengWeiCan" %>
...
<script type="text/javascript">
    $(function() {
        $("#TabFengWeiCan .fengweican").live("click", function() {
            ...
            url += $.param({ suppliertype: 2, hideID: $(hideObj).val(), callBack: "CallBackFengWeiCan", ShowID: $(showObj).val(), hidcaidanid: $(hidemenu).val(), LgType: lgtype })
            Boxy.iframeDialog({
                iframeUrl: url,
                title: "选择餐馆",
                modal: true,
    ...
    function CallBackFengWeiCan(obj) {
        ...
        $("#" + obj.aid).closest("td").next("td").find("input[name='txtfprice']").val(obj.pricejs);
