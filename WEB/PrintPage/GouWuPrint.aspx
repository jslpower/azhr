<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Print.Master" AutoEventWireup="true"
    CodeBehind="GouWuPrint.aspx.cs" Inherits="EyouSoft.Web.PrintPage.GouWuPrint"
...
<asp:Content ID="Content1" ContentPlaceHolderID="PrintC1" runat="server">
    ...
    <table width="696" border="0" align="center" cellpadding="0" cellspacing="0" class="list_2 borderbot_2">
        <tr>
            ...
            <td width="132">
                <input id="GWtime" type="text" class="input120" onfocus="WdatePicker()" runat="server" />
            </td>
            <th width="100" align="right">
                人数
            </th>
