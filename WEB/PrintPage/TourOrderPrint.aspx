<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TourOrderPrint.aspx.cs"
    Inherits="EyouSoft.Web.PrintPage.TourOrderPrint" ValidateRequest="false" %>
        ...
        <table width="696" border="0" align="center" cellpadding="0" cellspacing="0" class="list2"
            ...
            <tr>
                <th height="30" colspan="7" align="left" style="background: #993300; color: #fff;">
                    Bill To:
                    <%--<input type="text" id="CompanyName" runat="server" width="300px"  style="background: #993300; color: #fff;"/>--%>
                </th>
            </tr>
            <tr>
                <td height="30" colspan="7" align="left">
                    [Client Name/Company Name]
                    <input type="text" id="CompanyName2" runat="server" style=" width:300px" />
                </td>
            </tr>
            <tr>
        ...
        <table width="696" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td width="120" align="left" class="td_border">
                    <input type="text" value="" id="txtAmount" runat="server" class="input100" />
                </td>
            ...
            <tr>
                ...
                <td align="left" class="td_border">
                    <input type="text" value="" id="Text1" class="input100">
                </td>
            ...
            <tr>
                ...
                <td align="left" class="td_border">
                    <input type="text" value="" id="Text3" class="input100">
                </td>
            </tr>
  <tr>
