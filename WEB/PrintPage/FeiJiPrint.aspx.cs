...
{
    public partial class FeiJiPrint : BackPage
    {
        ...
        private void PageInit(string planid)
        {
            ...
            if (mPlan != null)
            {
                ...
                this.lbCostDesc.Text = EyouSoft.Common.UtilsCommons.GetAPMX(mPlan.PlanLargeFrequencyList, EyouSoft.Model.EnumType.PlanStructure.PlanProject.飞机.ToString());
                this.lbTotleCost.Text = EyouSoft.Common.UtilsCommons.GetMoneyString(mPlan.Confirmation, ProviderToMoney);
                this.lblPayType.Text = mPlan.PaymentType.ToString();
