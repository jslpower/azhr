<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuoteSimple.aspx.cs" Inherits="EyouSoft.Web.PrintPage.QuoteSimple"
                ...
                <tbody>
                    <tr class="font14">
                        ...
                        <td align="left" class="citybg">
                            <%#GetQuotePlanCity(Eval("QuotePlanCityList"))%>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="hanggao">
                             景点：<b><%#GetQuotePlanSpot(Eval("QuotePlanSpotList"))%></b>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="hanggao tjbg">
                            ...
                            早餐：<b><%#GetLngTypeRestaurant(Eval("BreakfastRestaurantId").ToString())%></b>
                            </span>
                            <span style="display: <%#Convert.ToBoolean(Eval("IsLunch"))?"":"none"%>">
                            午餐：<b><%#GetLngTypeRestaurant(Eval("LunchRestaurantId").ToString())%></b>
                            </span>
                            <span style="display: <%#Convert.ToBoolean(Eval("IsSupper"))?"":"none"%>">
                            晚餐：<b><%#GetLngTypeRestaurant(Eval("SupperRestaurantId").ToString())%></b>
                            </span>
                        </td>
                        <td rowspan="3">
                   ...
                   <%-- <tr>
                        ...
                        <td class="hanggao tjbg">
                            购物：<b><%#GetQuotePlanShop(Eval("QuotePlanShopList"))%></b>
                        </td>
                    </tr>
                    <tr>
                        <td>
