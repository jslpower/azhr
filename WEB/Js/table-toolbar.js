...
(function($) {
    $.fn.autoAdd = function(options) {
        ...
        content.find("." + settings.tempRowClass).each(function() {
            ...
            $(this).find(".xuanyong").each(function() {
                if ($(this).attr("id").length == 0)
                    $(this).attr("id", "a_" + Math.round(Math.random() * new Date().getTime()))
        ...
        function addRow(num, isInsert, target) {
            ...
            for (var i = 0; i < num - count; i++) {
                ...
                temp.attr("id", "");
                temp.find("input").removeAttr("data-ordinal");
                ...
                temp.find(".xuanyong").each(function() {
                    $(this).attr("id", "a_" + Math.round(Math.random() * new Date().getTime()))
                    $(this).show();
                });
