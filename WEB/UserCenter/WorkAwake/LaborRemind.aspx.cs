...
{
    public partial class LaborRemind : BackPage
    {
        /// <summary>
        /// 页面：DOM
        /// </summary>
        ...
        private void DataInit()
        {
            ...
            IList<MLaborContractExpireRemind> list = bllBIndividual.GetLaborContractExpireRemindLst(pageSize, pageIndex, ref recordCount, SiteUserInfo.CompanyId);
        ...
        {
            string msg = string.Empty;
            if (new EyouSoft.BLL.ComStructure.BComSetting().SetLaoDongHeTongTiXing(SiteUserInfo.CompanyId, Utils.GetInt(day)))
            {
                msg = UtilsCommons.AjaxReturnJson("true", "您设置劳动合同到期前" + day + "提醒成功");
            }
            else
                msg = UtilsCommons.AjaxReturnJson("false", "您设置劳动合同到期前" + day + "提醒失败");
        ...
        protected string GetLastTime()
        {
            ...
            if (setting != null) return setting.ContractRemind.ToString();
