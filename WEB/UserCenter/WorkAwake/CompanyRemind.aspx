<%@ Page Language="C#" MasterPageFile="~/MasterPage/UserCenter.Master" AutoEventWireup="true"
    CodeBehind="CompanyRemind.aspx.cs" Inherits="Web.UserCenter.WorkAwake.CompanyRemind" %>
            ...
            <div style="float: left;">
                <ul class="fixed">
                    ...
                    <li><s class="orderformicon"></s><a href="CompanyRemind.aspx?sl=<%=(int)EyouSoft.Model.EnumType.PrivsStructure.Menu2.个人中心_事务提醒 %>"
                        hidefocus="true" class="ztorderform de-ztorderform"><span>公司合同</span></a></li>
                </ul>
                <ul class="fixed">
            ...
            $("#btnSave").click(function() {
                ...
                if(ValiDatorForm.validator($(this).closest("form").get(0), "parent")){
                    $.newAjax({
                        ...
                        cache: false,
                        dataType:"json",
                        url: "CompanyRemind.aspx?doType=SetLastTime&argument=" + day,
