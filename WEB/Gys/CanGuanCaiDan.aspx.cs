...
{
    public partial class CanGuanCaiDan : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        ...
        void InitRpt()
        {
            var items = new EyouSoft.BLL.HGysStructure.BJiaGe().GetCanGuanCaiDans(GysId);
        ...
        void Delete()
        {
            ...
            string s = Utils.GetQueryStringValue("caidanid");
            int bllRetCode = new EyouSoft.BLL.HGysStructure.BJiaGe().DeleteCanGuanCaiDan(SiteUserInfo.CompanyId, GysId, s);
