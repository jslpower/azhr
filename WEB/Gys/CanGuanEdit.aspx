<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CanGuanEdit.aspx.cs" Inherits="EyouSoft.Web.Gys.CanGuanEdit"
...
<asp:Content ContentPlaceHolderID="PageBody" runat="server" ID="CPHBODY">
    ...
    <div class="alertbox-outbox">
        <table width="99%" align="center" cellpadding="0" cellspacing="0" bgcolor="#e9f4f9"
            ...
            <tr>
                ...
                <td colspan="3" align="left">
                    <input name="txtName" type="text" id="txtName" style="width: 260px;" class="input-txt"
                        runat="server" valid="required" errmsg="请输入餐厅名称" maxlength="255" />
                </td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input name="txtCaiXi" type="text" class="input-txt" id="txtCaiXi" style="width: 260px;"
                        runat="server" maxlength="255" />
                </td>
                <td align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                    餐标：
                ...
                <td colspan="3" align="left">
                    <input name="txtCanBiao" type="text" class="input-txt" id="txtCanBiao" style="width: 260px;"
                        runat="server" maxlength="255" />
                </td>
            </tr>
            <tr>
                ...
                <td height="53" colspan="7" align="left">
                    <textarea name="txtJianJie" id="txtJianJie" class="formsize600" style="height: 40px;" runat="server"></textarea>
                </td>
            </tr>
            <tr>
                <td height="28" align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                ...
                <td height="53" colspan="7" align="left">
                    <textarea name="txtBeiZhu" id="txtBeiZhu" class="formsize600" style="height: 40px;" runat="server"></textarea>
                </td>
            </tr>
            <tr>
                <td height="28" align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                ...
                <td align="left">
                    <input name="txtIsMianYi" type="radio" style="border: none" id="txtIsMianYi1" value="1" /><label
                        for="txtIsMianYi1">有</label>
                    <input type="radio" name="txtIsMianYi" style="border: none" id="txtIsMianYi0" value="0" /><label
                        for="txtIsMianYi0">无</label>
                </td>
                <td align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                    是否推荐：
                </td>
                <td align="left">
                    <input type="radio" name="txtIsTuiJian" id="txtIsTuiJian1" style="border: none;" value="1" /><label
                        for="txtIsTuiJian1">是</label>
            ...
            <tr>
                ...
                <td align="right" bgcolor="#b7e0f3" class="alertboxTableT">挂账期限：</td>
                <td colspan="5"><input name="txtGuaZhangQiXian" id="txtGuaZhangQiXian" type="text" class="input-txt"
                        runat="server" style="width: 260px;" maxlength="255" /></td>
            </tr>
            <tr>
                <td height="28" align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                    最后维护人：
        ...
        <uc1:GysHeTong runat="server" ID="GysHeTong1" IsBaoDi="true" IsJiangLi="true" />        
        <div class="hr_10">
        </div>
        ...
        <div class="alertbox-btn">
            ...
            <a href="javascript:void(0)" hidefocus="true" id="i_a_submit"><s class="baochun"></s>保 存</a>
            </asp:PlaceHolder>
        </div>
    </div>
    </form>
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            init: function() {
                $("input[name='txtIsMianYi']").each(function() { if (this.value == "<%=IsMianYi %>") this.checked = true; });
