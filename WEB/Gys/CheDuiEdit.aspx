<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheDuiEdit.aspx.cs" Inherits="EyouSoft.Web.Gys.CheDuiEdit"
...
<%@ Register Src="~/UserControl/GysCheXing.ascx" TagName="GysCheXing" TagPrefix="uc1" %>
<asp:Content ContentPlaceHolderID="PageBody" runat="server" ID="CPHBODY">
    ...
    <div class="alertbox-outbox">
            ...
            <tr>
                ...
                <td colspan="3" align="left">
                    <input name="txtName" type="text" id="txtName" style="width: 260px;" class="input-txt"
                        runat="server" valid="required" errmsg="请输入车队名称" maxlength="255" />
                </td>
        ...
        <uc1:GysCheXing runat="server" ID="GysCheXing1" />
        <div class="hr_10">
        </div>
