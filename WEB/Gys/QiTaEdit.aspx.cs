...
{
    public partial class QiTaEdit : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        ...
        void InitPrivs()
        {
            Privs_Insert = CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.资源管理_其他_新增);
            Privs_Update = CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.资源管理_其他_修改);
        ...
        void InitInfo()
        {
            ...
            txtJiaGe.Value = info.QiTa.JiaGe.ToString("F2");
            txtJieSuanJia.Value = info.QiTa.JieSuanJiaGe.ToString("F2");
        ...
        EyouSoft.Model.HGysStructure.MGysInfo GetFormInfo()
        {
            ...
            info.QiTa = new EyouSoft.Model.HGysStructure.MQiTaInfo();
            info.QiTa.JiaGe =Utils.GetDecimal( Utils.GetFormValue(txtJiaGe.UniqueID));
            info.QiTa.JieSuanJiaGe = Utils.GetDecimal(Utils.GetFormValue(txtJieSuanJia.UniqueID));
            ...
            info.LeiXing = EyouSoft.Model.EnumType.GysStructure.GysLeiXing.其他;
