<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiJie.aspx.cs" Inherits="EyouSoft.Web.Gys.DiJie"
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="CPHBODY" runat="server">
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            insert: function() {
                var _data = { sl: "<%=SL %>" };
                Boxy.iframeDialog({ title: "新增供应商", iframeUrl: "dijieedit.aspx", width: "940px", height: "650px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            update: function(obj) {
                var _$tr = $(obj[0]);
                var _data = { sl: "<%=SL %>", gysid: _$tr.attr("i_gysid") };
                Boxy.iframeDialog({ title: "修改供应商", iframeUrl: "dijieedit.aspx", width: "940px", height: "650px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            del: function(obj) {
                var _$tr = $(obj);
