<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JiuDianEdit.aspx.cs" Inherits="EyouSoft.Web.Gys.JiuDianEdit"
...
<%@ Register Src="~/UserControl/GysJiuDianBaoJia.ascx" TagName="GysJiuDianBaoJia"
    TagPrefix="uc1" %>
    ...
    <div class="alertbox-outbox">
        ...
        <table width="99%" align="center" cellpadding="0" cellspacing="0" bgcolor="#e9f4f9"
            ...
            <tr>
                ...
                <td colspan="3" align="left">
                    <input name="txtName" type="text" id="txtName" style="width: 260px;" class="input-txt"
                        runat="server" valid="required" errmsg="请输入酒店名称" maxlength="255" />
                </td>
            ...
            <tr>
                ...
                <td>
                    <select name="txtJiuDianXingJi" id="txtJiuDianXingJi">
                    <%=EyouSoft.Common.UtilsCommons.GetEnumDDL(EyouSoft.Common.EnumObj.GetList(typeof(EyouSoft.Model.EnumType.GysStructure.JiuDianXingJi),new string[]{"0"}),"","0","请选择") %>
                    </select>
                </td>
                <td align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                    前台电话：
                ...
                <td>
                    <input name="txtQianTaiTelephone" type="text" class="input-txt" id="txtQianTaiTelephone"
                        style="width: 80px;" runat="server" maxlength="255" />
                </td>
                <td align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                    网址：
                </td>
                <td colspan="3">
                    <input name="txtWangZhi" type="text" class="input-txt" id="txtWangZhi" style="width: 260px;"
                        runat="server" maxlength="255" />
                </td>
            </tr>
            <tr>
        ...
        <uc1:GysJiuDianBaoJia runat="server" ID="GysJiuDianBaoJia1" />
        <div class="hr_10">
        </div>
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            init: function() {
                ...
                $("#txtJiuDianXingJi").val("<%=XingJi %>");

                var _params = utilsUri.getUrlParams(["lng"]);

                $("#i_a_lng_1").attr("href", "JiuDianEdit.aspx?" + $.param(_params) + "&lng=1");
                $("#i_a_lng_2").attr("href", "JiuDianEdit.aspx?" + $.param(_params) + "&lng=2");
                $("#i_a_lng_3").attr("href", "JiuDianEdit.aspx?" + $.param(_params) + "&lng=3");
