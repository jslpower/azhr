<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QiTaEdit.aspx.cs" Inherits="EyouSoft.Web.Gys.QiTaEdit"
    ...
    <div class="alertbox-outbox">
        <table width="99%" align="center" cellpadding="0" cellspacing="0" bgcolor="#e9f4f9"
            ...
            <tr>
                ...
                <td>
                    <input name="txtJiaGe" type="text" class="input-txt" id="txtJiaGe" style="width: 80px;"
                ...
                <td colspan="5">
                    <input name="txtJieSuanJia" type="text" class="input-txt" id="txtJieSuanJia" style="width: 80px;"
                        runat="server" maxlength="10" />
                </td>
            </tr>
            <tr>
