...
{
    public partial class WuPinJieYue : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        ...
        void BaoCun()
        {
            if (!Privs_JieYue) RCWE(UtilsCommons.AjaxReturnJson("0", "无权限"));
        ...
        EyouSoft.Model.HGysStructure.MWuPinLingYongInfo GetFormInfo()
        {
            ...
            info.LingYongLeiXing = EyouSoft.Model.EnumType.GysStructure.WuPinLingYongLeiXing.借阅;
