...
{
    public partial class GouWu : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        /// <summary>
        /// privs insert
        ...
        void InitPrivs()
        {
            if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.资源管理_购物_栏目))
            {
