<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WuPinJieYue.aspx.cs" Inherits="EyouSoft.Web.Gys.WuPinJieYue"
    ...
    <div class="alertbox-outbox02">
        <table width="99%" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td height="28" align="left">
                    <uc1:SellsSelect ID="txtRen" runat="server" SelectFrist="false" ReadOnly="true" SetTitle="借阅人" />
                </td>
            </tr>
            <tr>
        ...
        <div class="alertbox-btn">
            <asp:PlaceHolder runat="server" ID="phSubmit"><a href="javascript:void(0)" hidefocus="true"
                id="i_a_submit"><s class="baochun"></s>借阅</a> </asp:PlaceHolder>
        </div>
    </div>
    </form>
