...
{
    public partial class JiaoTong : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        /// <summary>
        /// privs insert
        ...
        void InitPrivs()
        {
            if (!CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.资源管理_区间交通_栏目))
            {
                RCWE(UtilsCommons.AjaxReturnJson("0", "无栏目权限"));
            }

            Privs_Insert = CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.资源管理_区间交通_新增);
            Privs_Update = CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs.资源管理_区间交通_修改);
        }
        ...
        EyouSoft.Model.HGysStructure.MLBChaXunInfo GetChaXunInfo()
        {
            ...
            info.LeiXing = EyouSoft.Model.EnumType.GysStructure.GysLeiXing.区间交通;
        ...
        void ToXls()
        {
            ...
            s.Append("所在地\t单位名称\t联系人\t交易次数\t交易人数\t结算金额\t未付金额\n");
