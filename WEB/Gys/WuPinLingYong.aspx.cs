...
{
    public partial class WuPinLingYong : EyouSoft.Common.Page.BackPage
    {
        #region attributes
        ...
        void InitPrivs()
        {
            ...
            phSubmit.Visible = Privs_LingYong;
        }
        ...
        void BaoCun()
        {
            if (!Privs_LingYong) RCWE(UtilsCommons.AjaxReturnJson("0", "无权限"));
        ...
        EyouSoft.Model.HGysStructure.MWuPinLingYongInfo GetFormInfo()
        {
            ...
            info.LingYongLeiXing = EyouSoft.Model.EnumType.GysStructure.WuPinLingYongLeiXing.领用;
