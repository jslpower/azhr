<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheDui.aspx.cs" Inherits="EyouSoft.Web.Gys.CheDui"
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="CPHBODY" runat="server">
                ...
                <asp:Repeater runat="server" ID="rpt">
                    <ItemTemplate>
                        <tr i_gysid="<%#Eval("GysId") %>">
                            ...
                            <td align="center">
                                <a href="javascript:void(0)" class="i_chexing"><%#Eval("CheDuiCheXingName") %>
                                    </a>
                            </td>
                            <td align="center">
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            insert: function() {
                var _data = { sl: "<%=SL %>" };
                Boxy.iframeDialog({ title: "新增供应商", iframeUrl: "cheduiedit.aspx", width: "940px", height: "650px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            update: function(obj) {
                var _$tr = $(obj[0]);
                var _data = { sl: "<%=SL %>", gysid: _$tr.attr("i_gysid") };
                Boxy.iframeDialog({ title: "修改供应商", iframeUrl: "cheduiedit.aspx", width: "940px", height: "650px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            del: function(obj) {
                var _$tr = $(obj);
            ...
            cheXing: function(obj) {
                var _$tr = $(obj).closest("tr");
                var _data = { sl: "<%=SL %>", gysid: _$tr.attr("i_gysid") };
                Boxy.iframeDialog({ title: "车型信息", iframeUrl: "cheduichexing.aspx", width: "840px", height: "550px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
        ...
        $(document).ready(function() {
            ...
            $(".i_chexing").click(function() { iPage.cheXing(this); });
