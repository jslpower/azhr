...
{
    public partial class CanGuanEdit : BackPage
    {
        #region attributes
        ...
        void InitInfo()
        {
            ...
            txtCaiXi.Value = info.CanGuan.CaiXi;
            txtCanBiao.Value = info.CanGuan.CanBiao;
        ...
        EyouSoft.Model.HGysStructure.MGysInfo GetFormInfo()
        {
            ...
            info.CanGuan.CaiXi = Utils.GetFormValue(txtCaiXi.UniqueID);
            info.CanGuan.CanBiao = Utils.GetFormValue(txtCanBiao.UniqueID);
