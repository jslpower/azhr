<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DiJieEdit.aspx.cs" Inherits="EyouSoft.Web.Gys.DiJieEdit"
    ...
    <div class="alertbox-outbox">
        <table width="99%" align="center" cellpadding="0" cellspacing="0" bgcolor="#e9f4f9"
            ...
            <tr>
                ...
                <td colspan="3">
                    <input name="txtXuKeZhengHao" type="text" class="input-txt" id="txtXuKeZhengHao"
                        style="width: 260px;" runat="server" maxlength="255" />
                </td>
                <td  align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                    法人姓名：
                </td>
                <td>
                    <input name="txtFaRenName" type="text" class="input-txt" id="txtFaRenName" style="width: 80px;"
                        runat="server" maxlength="255" />
                </td>
                <td align="right" bgcolor="#b7e0f3" class="alertboxTableT">
                    法人电话：
                ...
                <td>
                    <input name="txtFaRenTelephone" type="text" class="input-txt" id="txtFaRenTelephone"
            ...
            <tr>                
                ...
                <td align="left">
                    <input type="radio" name="txtIsQianDan" id="txtIsQianDan1" style="border: none;" value="1" /><label
                        for="txtIsQianDan1">是</label>
