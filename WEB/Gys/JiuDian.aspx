<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JiuDian.aspx.cs" Inherits="EyouSoft.Web.Gys.JiuDian"
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="CPHBODY" runat="server">
        ...
        <div class="searchbox border-bot fixed">
            ...
            <span class="searchT">
                <p>
                    ...
                    星级：
                    <select name="txtXingJi" id="txtXingJi">
                        <%=EyouSoft.Common.UtilsCommons.GetEnumDDL(EyouSoft.Common.EnumObj.GetList(typeof(EyouSoft.Model.EnumType.GysStructure.JiuDianXingJi)),"","","请选择") %>
                    </select>
                ...
                <asp:Repeater runat="server" ID="rpt">
                    <ItemTemplate>
                        <tr i_gysid="<%#Eval("GysId") %>">
                            ...
                            <td align="center">
                                <a href="javascript:void(0)" class="i_fangxing">价格管理</a>
                            </td>
                            <td align="center">
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            insert: function() {
                var _data = { sl: "<%=SL %>" };
                Boxy.iframeDialog({ title: "新增供应商", iframeUrl: "jiudianedit.aspx", width: "940px", height: "650px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            update: function(obj) {
                var _$tr = $(obj[0]);
                var _data = { sl: "<%=SL %>", gysid: _$tr.attr("i_gysid") };
                Boxy.iframeDialog({ title: "修改供应商", iframeUrl: "jiudianedit.aspx", width: "940px", height: "650px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            del: function(obj) {
                var _$tr = $(obj);
            ...
            fangXing: function(obj) {
                var _$tr = $(obj).closest("tr");
                var _data = { sl: "<%=SL %>", gysid: _$tr.attr("i_gysid") };
                Boxy.iframeDialog({ title: "价格管理", iframeUrl: "JiuDianJiaGe.aspx", width: "840px", height: "550px", data: _data });
                return false;
            }
        };
