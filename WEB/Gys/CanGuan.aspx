<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CanGuan.aspx.cs" Inherits="EyouSoft.Web.Gys.CanGuan"
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" ID="CPHBODY" runat="server">
        ...
        <div class="searchbox border-bot fixed">
            ...
            <span class="searchT">
                <p>
                    ...
                    国家：
                    <select id="txtCountryId" name="txtCountryId"></select>
                    省份：
                    <select id="txtProvinceId" name="txtProvinceId"></select>
                    城市：
                    <select id="txtCityId" name="txtCityId"></select>                    
                    餐厅名称：
                    <input type="text" id="txtName" name="txtName" class="input-txt" maxlength="50" />
                    菜系：
                    <input type="text" id="txtCaiXi" name="txtCaiXi" class="input-txt" maxlength="50" />
        ...
        <div class="tablehead" id="i_div_tool_paging_1">
            <ul class="fixed">
                ...
                <li><s class="delicon"></s><a href="javascript:void(0)" hidefocus="true" class="toolbar_delete"><span>
                    删除</span></a></li>
                <li class="line"></li>
                <li><s class="daochu"></s><a href="javascript:void(0)" hidefocus="true" class="toolbar_daochu" id="i_a_toxls"><span>
                    导出</span></a></li>
            </ul>
            <div class="pages">
        ...
        <div class="tablelist-box">
            <table border="0" cellspacing="0" id="liststyle" width="100%">
                ...
                <tr i_gysid="<%#Eval("GysId") %>">
                    ...
                    <td align="center">
                        <a href="javascript:void(0)" class="i_caidan"><%#Eval("CanGuanCaiDanName") %></a>
                    </td>
                    <td align="center">
                        <span style="display: none;"><%#EyouSoft.Web.Gys.GY.GetLxrHtml(Eval("Lxrs"))%></span>
                        <a href="javascript:void(0)" class="i_fd_lxr"><%#Eval("LxrName") %></a>
                    </td>
                    <td align="center">
                        <%#Eval("CanGuanCanBiao") %>
                    </td>
                    ...
                    <td align="center">
                        <a href="javascript:void(0)" class="i_jiaoyimingxi"><%# ToMoneyString(Eval("JiaoYiXX.JieSuanJinE"))%></a>
                    </td>
                    <td align="center">
    ...
    <script type="text/javascript">
        var iPage = {
            ...
            insert: function() {
                var _data = { sl: "<%=SL %>" };
                Boxy.iframeDialog({ title: "新增供应商", iframeUrl: "canguanedit.aspx", width: "940px", height: "650px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            update: function(obj) {
                var _$tr = $(obj[0]);
                var _data = { sl: "<%=SL %>", gysid: _$tr.attr("i_gysid") };
                Boxy.iframeDialog({ title: "修改供应商", iframeUrl: "canguanedit.aspx", width: "940px", height: "650px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
            del: function(obj) {
                var _$tr = $(obj);
            ...
            caiDan: function(obj) {
                ...
                var _data = { sl: "<%=SL %>", gysid: _$tr.attr("i_gysid") };
                Boxy.iframeDialog({ title: "菜单管理", iframeUrl: "canguancaidan.aspx", width: "840px", height: "550px", data: _data, afterHide: function() { iPage.reload(); } });
                return false;
            },
        ...
        $(document).ready(function() {
            ...
            $(".i_caidan").click(function() { iPage.caiDan(this); });
