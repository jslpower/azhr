<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XingChengLiangDianBJ.aspx.cs"
    Inherits="EyouSoft.Web.Sys.XingChengLiangDianBJ"   ValidateRequest="false"%>
            ...
            pageSave: function() {
                ...
                if (ValiDatorForm.validator("form", "parent")) {
                    $.newAjax({
                        type: "post",
                        cache: false,
                        url: "/Sys/XingChengLiangDianBJ.aspx?" + $.param(pageOpt.Params),
