<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="XingChengBeiZhu.aspx.cs" Inherits="EyouSoft.Web.Sys.XingChengBeiZhu" %>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            $("[name=a_add]").click(function() {
                pageOption.openXLwindow("XingChengBeiZhuBJ.aspx?dotype=add&sl=" + pageOption.sl, "添加", 750, 350);
            }); //添加
            $("a[name=a_edit]").each(function() {
                $(this).click(function() {
                    var chk = $(this).closest("tr").find("[name=chk_ids]");
                    var url = "XingChengBeiZhuBJ.aspx?dotype=update&id=" + chk.attr("id") + "&lngType=" + chk.attr("data-lng") + "&master=" + chk.attr("data-master");
            ...
            $("a[name=a_del]").each(function() {
                $(this).click(function() {
                    $.newAjax({
                        type: "get",
                        cache: false,
                        url: "/Sys/XingChengBeiZhu.aspx?dotype=del&id=" + $(this).closest("tr").find("[name=chk_ids]").attr("id") + "&sl=" + pageOption.sl,
                        dataType: "json",
