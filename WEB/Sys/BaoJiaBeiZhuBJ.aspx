<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BaoJiaBeiZhuBJ.aspx.cs" ValidateRequest="false"
    Inherits="EyouSoft.Web.Sys.BaoJiaBeiZhuBJ" %>
            ...
            pageSave: function() {
                ...
                if (ValiDatorForm.validator("form", "parent")) {
                    $.newAjax({
                        type: "post",
                        cache: false,
                        url: "/Sys/BaoJiaBeiZhuBJ.aspx?" + $.param(pageOpt.Params),
