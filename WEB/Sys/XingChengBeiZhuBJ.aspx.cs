...
{
    public partial class XingChengBeiZhuBJ : BackPage
    {
        ...
        protected void initPage()
        {
            ...
            else
            {
                ...
                if (id != 0)
                {
                    MSysJourneyMark model = new BSysOptionConfig().GetJourneyMark(id);
        ...
        protected void save(string dotype)
        {
            ...
            MSysJourneyMark model = new MSysJourneyMark();
            ...
            switch (dotype)
            {
                ...
                case "update":
                    ...
                    if (bll.isEsistsMSysJourneyMark(model.MasterId, model.LngType))
                    {
                        result = bll.UpdateMSysJourneyMark(model);
                    }
                    else
                    {
                        result = bll.AddMSysJourneyMark(model);
                    }
