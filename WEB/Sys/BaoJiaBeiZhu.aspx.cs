...
{
    public partial class BaoJiaBeiZhu : BackPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                int result = new BSysOptionConfig().DeleteMBackPriceMark(id);
                if (result == 1)
                {
        ...
        private void initPage()
        {
            ...
            IList<MBackPriceMark> list = new BSysOptionConfig().GetMBackPriceMarkList(SiteUserInfo.CompanyId, pageSize, pageIndex, ref recordCount, null);
            if (list.Count > 0)
            {
