...
<asp:content runat="server" contentplaceholderid="Scripts" id="ScriptsContent">
	...
	<script type="text/javascript">
	    ...
	    $(document).ready(function() {
	        ...
	        $("#<%=btnUpdateSecondUrl.ClientID %>").bind("click", function() { return WebForm_OnSubmit_Validate4(); });
	    });	    
    </script>
...
<asp:content runat="server" contentplaceholderid="PageContent" id="MainContent">
    <table cellpadding="2" cellspacing="1" style="font-size: 12px; width: 100%;">
            ...
            <td>
                ...
                <span>
                    <select name="txtPrivsType" id="txtPrivsType">
                        ...
                        <option value="<%=(int)EyouSoft.Model.EnumType.SysStructure.PrivsType.本部浏览 %>"><%=EyouSoft.Model.EnumType.SysStructure.PrivsType.本部浏览%></option>
                        <option value="<%=(int)EyouSoft.Model.EnumType.SysStructure.PrivsType.部门浏览 %>"><%=EyouSoft.Model.EnumType.SysStructure.PrivsType.部门浏览%></option>
                        <option value="<%=(int)EyouSoft.Model.EnumType.SysStructure.PrivsType.内部浏览 %>"><%=EyouSoft.Model.EnumType.SysStructure.PrivsType.内部浏览%></option>
                        <option value="<%=(int)EyouSoft.Model.EnumType.SysStructure.PrivsType.查看全部 %>"><%=EyouSoft.Model.EnumType.SysStructure.PrivsType.查看全部%></option>                        
                    </select>
                </span>
        ...
        <tr>
            <td>
                修改二级栏目URL：<span id="spanUpdateMenu2UrlFirst"></span><span id="spanUpdateMenu2UrlSecond"></span>
                链接：<input type="text" id="txtUpdateSecondUrl" name="txtUpdateSecondUrl" class="input_text" maxlength="255" style="width: 300px" />
            </td>
        </tr>
        <tr>
            <td style="height:30px;">
                <asp:Button ID="btnUpdateSecondUrl" runat="server" Text="修改二级栏目URL" OnClick="btnUpdateSecondUrl_Click" /><br /><br />
            </td>
        </tr>
        <tr id="trPermissions">
            <td>
...
<asp:content runat="server" contentplaceholderid="PageRemark" id="RemarkContent">
    <ul class="decimal">
        ...
        <li>权限类别-其它：非栏目、本部浏览、部门浏览、内部浏览、查看全部类别的均标记为其它。</li>
    </ul>
</asp:content>
