...
namespace Web.Webmaster
{
    ...
    public partial class _domain : WebmasterPageBase
    {
        ...
        /// </summary>
        /// <returns></returns>
        private IList<EyouSoft.Model.SysStructure.MSysDomain> GetDomains()
        {
            IList<EyouSoft.Model.SysStructure.MSysDomain> items = new List<EyouSoft.Model.SysStructure.MSysDomain>();
            ...
            for (int i = 0; i < domains.Length; i++)
            {
                ...
                items.Add(new EyouSoft.Model.SysStructure.MSysDomain()
                {
                    Domain = s,
                    SysId = SysId,
                    Url = urls[i]
