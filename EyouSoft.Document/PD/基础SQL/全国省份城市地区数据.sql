...
--数据导入
/*
delete from tbl_syscounty
delete from tbl_syscity
delete from tbl_sysprovince
delete from tbl_syscountry

SET IDENTITY_INSERT [tbl_syscountry] ON
INSERT INTO [tbl_SysCountry]([CountryId],[CompanyId],[Name],[JP],[QP],[EnName],[IsDefault])
VALUES(1,'','中国','','','','1')
SET IDENTITY_INSERT [tbl_syscountry] OFF

SET IDENTITY_INSERT [tbl_sysprovince] ON
INSERT INTO [tbl_SysProvince]([provinceid],[CountryId],[Name],[JP],[QP],[EnName])
SELECT [ProvinceID],1,[ProvinceName],'','','' from wangqizhi.mydb.dbo.[s_province]
SET IDENTITY_INSERT [tbl_sysprovince] OFF

SET IDENTITY_INSERT [tbl_syscity] ON
INSERT INTO [tbl_SysCity]([CityId],[ProvinceId],[Name],[JP],[QP],[EnName])
SELECT cityid,provinceid,cityname,'','','' from wangqizhi.mydb.dbo.[s_city]
SET IDENTITY_INSERT [tbl_syscity] OFF

SET IDENTITY_INSERT [tbl_syscounty] ON
INSERT INTO [tbl_SysCounty]([countyid],[CityId],[Name],[JP],[QP],[EnName])
SELECT DistrictID,cityid,districtname,'','','' from wangqizhi.mydb.dbo.[s_district]
