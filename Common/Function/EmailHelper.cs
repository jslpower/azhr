    ...
    public class EmailHelper
    {
        ...
        protected bool IsEnableSSL
        {
            get
            {
                ...
                Boolean.TryParse(Adpost.Common.Function.ConfigModel.GetConfigString("MailSettings", "IsEnableSSL"), out isenablessl);
                return isenablessl;
            }
        }
        /// <summary>
        ...
        protected string SendAddress
        {
            get
            {
                return Adpost.Common.Function.ConfigModel.GetConfigString("MailSettings", "SendAddress");
            }
        }
        /// <summary>
