...
var gscx = {
    ...
    _post: function(t, options, pv, fn) {
        ...
        if (options.lng == "3") {
            _self._loadHTML = "กรุณาเลือก";
            _self._loadHTML = "โปรดรอสักครู่";
        }
    ...
    init: function(options) {
        ...
        var _$l = this._getObj(options.lng);
        var _self = this;
        ...
        if (_$x) { }
        if (options.lng == "3") {
            gscx._defaultHTML = "<option value=\"\">กรุณาเลือก</option>";
            gscx._loadHTML = "<option value=\"\">โปรดรอสักครู่...</option>";
        }
