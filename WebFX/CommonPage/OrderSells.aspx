<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderSells.aspx.cs" Inherits="EyouSoft.WebFX.CommonPage.OrderSells" %>
    ...
    <script type="text/javascript">
        var OrderSellsPage = {
            ...
            SearchFun: function(key, deptId) {
                ...
                data.userName = key;
                data.deptId = deptId;
                window.location.href = "OrderSells.aspx?" + $.param(data);
            },
            BtnBind: function() {
