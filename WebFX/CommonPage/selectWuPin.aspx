<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selectWuPin.aspx.cs" Inherits="EyouSoft.WebFX.CommonPage.selectWuPin" %>
                        ...
                        <asp:Repeater ID="rpt_WuPinList" runat="server">
                            <ItemTemplate>
                                <td align="left" height="28">
                                    ...
                                    <input id="<%#Eval("WuPinId") %>" name="radiogroup" data-num='<%# Eval("ShuLiang.KuCun")%>' data-price='<%#Convert.ToDecimal(Eval("DanJia")).ToString("f2") %>'
                                        type="radio" value="<%#Eval("WuPinId") %>" data-show="<%#Eval("Name")%>" />
