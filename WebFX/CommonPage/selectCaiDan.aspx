<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="selectCaiDan.aspx.cs" Inherits="EyouSoft.WebFX.CommonPage.selectCaiDan" %>
...
<body>
    ...
    <div class="alertbox-outbox">
        <div style="margin: 0 auto; width: 99%;">
            <span class="formtableT formtableT02 t1"><%=(String)GetGlobalResourceObject("string", "选择菜单") %> </span>
