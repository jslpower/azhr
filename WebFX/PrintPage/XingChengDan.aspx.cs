...
namespace EyouSoft.WebFX.PrintPage
{
    ...
    public partial class XingChengDan : EyouSoft.Common.Page.FrontPage
    {
        /// <summary>
        /// 语言
        /// </summary>
        ...
        private void PageInit(string quoteId, EyouSoft.Model.EnumType.TourStructure.TourType type)
        {
            ...
            if (model != null)
            {
                ...
                //绑定地接社
                if (model.TourDiJieList != null && model.TourDiJieList.Count > 0)
                {
                ...
                {
                    this.rpPrice.DataSource = model.TourPriceList.Where(c => c.CostMode == EyouSoft.Model.EnumType.TourStructure.CostMode.销售价格 && c.LevelId == SiteUserInfo.TourCompanyInfo.LevelId);
