<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuoteSimple.aspx.cs" Inherits="EyouSoft.WebFX.PrintPage.QuoteSimple"
            ...
            <table width="696" cellspacing="0" cellpadding="0" border="0" align="center" style="margin-top: 0;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="hanggao">
                             <%=(String)GetGlobalResourceObject("string", "景点")%>：<b><%#GetQuotePlanSpot(Eval("QuotePlanSpotList"))%></b>：<b><%#GetQuotePlanSpot(Eval("QuotePlanSpotList"))%></b>
                        </td>
                ...
                <ItemTemplate>
                    <tr>
                        <td height="30" align="left" class="beizhu">
                            ...
                            <%=(String)GetGlobalResourceObject("string", "元人")%>&nbsp;
                            <%=(String)GetGlobalResourceObject("string", "单房差")%>
