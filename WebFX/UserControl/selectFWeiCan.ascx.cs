...
{
    public partial class selectFWeiCan : System.Web.UI.UserControl
    {
        /// <summary>
        /// 设置风味餐数据源（用作初始化表单）
        /// </summary>
        ...
        protected string getIsDelBtn(object obj)
        {
            ...
            if (footid == "")
            {
                str = "<a href='javascript:void(0)' class='delbtnfwei'> <img width='48' height='20' src='" + (String)GetGlobalResourceObject("string", "图片删除链接") + "'></a>";
            }
            return str;
        }
    }
