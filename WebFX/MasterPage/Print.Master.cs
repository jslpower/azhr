...
namespace EyouSoft.WebFX.MasterPage
{
    ...
    public partial class Print : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (SiteUserInfo != null)
            {
                ...
                {
                    DepartStamp = CustomerConfig.Seal;
                    PageHeadFile = CustomerConfig.PrintHeader;
                    PageFootFile = CustomerConfig.PrintFooter;
                }
            }
        ...
        protected void ibtnWord_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //    {
            //        //判断文件是否存在
            //        if (System.IO.File.Exists(Utils.GetMapPath(CustomerConfig.PrintTemplates)))
            //        {
