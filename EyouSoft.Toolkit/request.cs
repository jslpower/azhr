...
namespace EyouSoft.Toolkit
{
    ...
    {
        Bitmap m_Bitmap;
        string m_Url, m_Cookies = "",m_CompanyId;//"TYPE_LTU=admin; ASP.NET_SessionId=poxvt1iumeglbl55yqsqal55; SYS_YIBAI_CID=1; SYS_YIBAI_SID=1; SYS_YIBAI_UID=1; SYS_YIBAI_UN=admin; SYS_YIBAI_SESSIONID=8d6668b5-a60f-4153-86f9-d30e295b4c56; SYS_YIBAI_VC=9714"; 
        ...
        public request(string Url, int BrowserWidth, int BrowserHeight, int ThumbnailWidth, int ThumbnailHeight, string CompanyId, HttpCookieCollection Cookie) 
        {
            m_Url = Url; 
        ...
        public static Bitmap GetWebSiteThumbnail(string Url, int BrowserWidth, int BrowserHeight, int ThumbnailWidth, int ThumbnailHeight, string CompanyId, HttpCookieCollection Cookie)
        {
