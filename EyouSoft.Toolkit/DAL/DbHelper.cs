...
namespace EyouSoft.Toolkit.DAL
{
    ...
    public static class DbHelper
    {
        ...
        public static IDataReader ExecuteReader(Database db, int pageSize, int pageIndex, ref int recordCount, string tableName, string identityColumnName, string fields, string query, string orderByString)
        {
            ...
            db.AddInParameter(cmd, "XMLSumField", DbType.String, "");
            ...
            db.AddInParameter(cmd, "GroupString", DbType.String, "");
        ...
        /// <param name="tableName">查询的数据库表名</param>
        /// <param name="xmlSumField">主键字段</param>
        /// <param name="fields">要查询的字段</param>
        /// <param name="query">查询的条件</param>
        /// <param name="orderByString">排序</param>
        /// <returns></returns>
        public static IDataReader ExecuteReader(Database db, int pageSize, int pageIndex, ref int recordCount, ref string xmlSum, string tableName, string xmlSumField, string fields, string query, string orderByString)
        {
            DbCommand cmd = db.GetStoredProcCommand("T_StocPage");
            db.AddInParameter(cmd, "PageSize", DbType.Int32, pageSize);
            db.AddInParameter(cmd, "PageIndex", DbType.Int32, pageIndex);
            db.AddInParameter(cmd, "TableName", DbType.String, tableName.Trim());
            db.AddInParameter(cmd, "XMLSumField", DbType.String, xmlSumField);
            db.AddInParameter(cmd, "FieldsList", DbType.String, fields);
            db.AddInParameter(cmd, "FieldSearchKey", DbType.String, query);
            db.AddInParameter(cmd, "OrderString", DbType.String, orderByString);
            db.AddInParameter(cmd, "GroupString", DbType.String, "");
        ...
        /// <param name="query">查询的条件</param>
        /// <param name="orderByString">排序</param>
        /// <param name="groupByString">合计金额分组条件</param>
        /// <returns></returns>
        public static IDataReader ExecuteReader(Database db, int pageSize, int pageIndex, ref int recordCount, ref string xmlSum, string tableName, string xmlSumField, string fields, string query, string orderByString, string groupByString)
        {
            DbCommand cmd = db.GetStoredProcCommand("T_StocPage");
            db.AddInParameter(cmd, "PageSize", DbType.Int32, pageSize);
            db.AddInParameter(cmd, "PageIndex", DbType.Int32, pageIndex);
            ...
            db.AddInParameter(cmd, "FieldSearchKey", DbType.String, query);
            db.AddInParameter(cmd, "OrderString", DbType.String, orderByString);
            db.AddInParameter(cmd, "GroupString", DbType.String, groupByString);
        ...
        /// 第二个是合计结果集
        /// </returns>
        public static IDataReader ExecuteReader(Database db, int pageSize, int pageIndex, ref int recordCount, string tableName
            , string fields, string query, string orderByString, string groupString, string sumString)
        {
            ...
            db.AddInParameter(cmd, "GroupBy", DbType.String, groupString);
        ...
        {
            DbCommand cmd = db.GetStoredProcCommand("proc_Paging");
            db.AddInParameter(cmd, "PageSize", DbType.Int32, pageSize);
            db.AddInParameter(cmd, "PageIndex", DbType.Int32, pageIndex);
            db.AddInParameter(cmd, "TableName", DbType.String, tableName.Trim());
            db.AddInParameter(cmd, "Fields", DbType.String, fields);
